...
then((_ref) => {let config = _ref.config,hasDeprecationWarnings = _ref.hasDeprecationWarnings;return {
...
const readRawConfig = (argv, root) => {
  ...
  then((_ref2) => {let config = _ref2.config,hasDeprecationWarnings = _ref2.hasDeprecationWarnings;
    if (config) {
      return {
        config,
        hasDeprecationWarnings };
